...
/* 219 */     EnumFacing side = getFirstFacing(pos);
/* 220 */     if (side == null) return false; 
/* 221 */     BlockPos neighbour = pos.func_177972_a(side);
/* 222 */     EnumFacing opposite = side.func_176734_d();
/* 223 */     Vec3d hitVec = (new Vec3d((Vec3i)neighbour)).func_72441_c(0.5D, 0.5D, 0.5D).func_178787_e((new Vec3d(opposite.func_176730_m())).func_186678_a(0.5D));
/* 224 */     Block neighbourBlock = mc.field_71441_e.func_180495_p(neighbour).func_177230_c();
/* 225 */     if (!mc.field_71439_g.func_70093_af() && (blackList.contains(neighbourBlock) || shulkerList.contains(neighbourBlock))) {
/* 226 */       mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketEntityAction((Entity)mc.field_71439_g, CPacketEntityAction.Action.START_SNEAKING));
/* 227 */       mc.field_71439_g.func_70095_a(true);
/*     */     } 
/* 229 */     if (rotate) RotationUtil.faceVector(altRotate ? new Vec3d((Vec3i)pos) : hitVec, true); 
/* 230 */     rightClickBlock(neighbour, hitVec, hand, opposite, packet);
/* 231 */     mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
/* 232 */     return true;
/*     */   }
/*     */   
/*     */   public static Vec3d[] getHelpingBlocks(Vec3d vec3d) {
/* 236 */     return new Vec3d[] { new Vec3d(vec3d.field_72450_a, vec3d.field_72448_b - 1.0D, vec3d.field_72449_c), new Vec3d((vec3d.field_72450_a != 0.0D) ? (vec3d.field_72450_a * 2.0D) : vec3d.field_72450_a, vec3d.field_72448_b, (vec3d.field_72450_a != 0.0D) ? vec3d.field_72449_c : (vec3d.field_72449_c * 2.0D)), new Vec3d((vec3d.field_72450_a == 0.0D) ? (vec3d.field_72450_a + 1.0D) : vec3d.field_72450_a, vec3d.field_72448_b, (vec3d.field_72450_a == 0.0D) ? vec3d.field_72449_c : (vec3d.field_72449_c + 1.0D)), new Vec3d((vec3d.field_72450_a == 0.0D) ? (vec3d.field_72450_a - 1.0D) : vec3d.field_72450_a, vec3d.field_72448_b, (vec3d.field_72450_a == 0.0D) ? vec3d.field_72449_c : (vec3d.field_72449_c - 1.0D)), new Vec3d(vec3d.field_72450_a, vec3d.field_72448_b + 1.0D, vec3d.field_72449_c) };
/*     */   }
/*     */   
/*     */   public static List<BlockPos> possiblePlacePositions(float placeRange) {
/* 240 */     NonNullList positions = NonNullList.func_191196_a();
/* 241 */     positions.addAll((Collection)getSphere(EntityUtil.getPlayerPos((EntityPlayer)mc.field_71439_g), placeRange, (int)placeRange, false, true, 0).stream().filter(BlockUtil::canPlaceCrystal).collect(Collectors.toList()));
/* 242 */     return (List<BlockPos>)positions;
/*     */   }
/*     */   
/*     */   public static List<BlockPos> getSphere(BlockPos pos, float r, int h, boolean hollow, boolean sphere, int plus_y) {
/* 246 */     ArrayList<BlockPos> circleblocks = new ArrayList<>();
/* 247 */     int cx = pos.func_177958_n();
/* 248 */     int cy = pos.func_177956_o();
/* 249 */     int cz = pos.func_177952_p();
/* 250 */     int x = cx - (int)r;
/* 251 */     while (x <= cx + r) {
/* 252 */       int z = cz - (int)r;
/* 253 */       while (z <= cz + r) {
/* 254 */         int y = sphere ? (cy - (int)r) : cy;
/*     */         while (true) {
/* 256 */           float f = y;
/* 257 */           float f2 = sphere ? (cy + r) : (cy + h);
/* 258 */           if (f >= f2)
/* 259 */             break;  double dist = ((cx - x) * (cx - x) + (cz - z) * (cz - z) + (sphere ? ((cy - y) * (cy - y)) : 0));
/* 260 */           if (dist < (r * r) && (!hollow || dist >= ((r - 1.0F) * (r - 1.0F)))) {
/* 261 */             BlockPos l = new BlockPos(x, y + plus_y, z);
/* 262 */             circleblocks.add(l);
/*     */           } 
/* 264 */           y++;
/*     */         } 
/* 266 */         z++;
...
/* 305 */     NonNullList positions = NonNullList.func_191196_a();
/* 306 */     positions.addAll((Collection)getSphere(EntityUtil.getPlayerPos((EntityPlayer)mc.field_71439_g), placeRange, (int)placeRange, false, true, 0).stream().filter(pos -> canPlaceCrystal(pos, specialEntityCheck, oneDot15)).collect(Collectors.toList()));
/* 307 */     return (List<BlockPos>)positions;
/*     */   }
/*     */   
/*     */   public static boolean canPlaceCrystal(BlockPos blockPos, boolean specialEntityCheck, boolean oneDot15) {
/* 311 */     BlockPos boost = blockPos.func_177982_a(0, 1, 0);
/* 312 */     BlockPos boost2 = blockPos.func_177982_a(0, 2, 0);
/*     */     try {
/* 314 */       if (mc.field_71441_e.func_180495_p(blockPos).func_177230_c() != Blocks.field_150357_h && mc.field_71441_e.func_180495_p(blockPos).func_177230_c() != Blocks.field_150343_Z) {
/* 315 */         return false;
/*     */       }
/* 317 */       if ((!oneDot15 && mc.field_71441_e.func_180495_p(boost2).func_177230_c() != Blocks.field_150350_a) || mc.field_71441_e.func_180495_p(boost).func_177230_c() != Blocks.field_150350_a) {
/* 318 */         return false;
/*     */       }
/* 320 */       for (Entity entity : mc.field_71441_e.func_72872_a(Entity.class, new AxisAlignedBB(boost))) {
/* 321 */         if (entity.field_70128_L || (specialEntityCheck && entity instanceof net.minecraft.entity.item.EntityEnderCrystal))
/* 322 */           continue;  return false;
/*     */       } 
/* 324 */       if (!oneDot15) {
/* 325 */         for (Entity entity : mc.field_71441_e.func_72872_a(Entity.class, new AxisAlignedBB(boost2))) {
/* 326 */           if (entity.field_70128_L || (specialEntityCheck && entity instanceof net.minecraft.entity.item.EntityEnderCrystal))
/* 327 */             continue;  return false;
/*     */         } 
/*     */       }
...
/* 337 */     return getBlock(pos).func_176209_a(getState(pos), false);
/*     */   }
/*     */   
/*     */   private static Block getBlock(BlockPos pos) {
/* 341 */     return getState(pos).func_177230_c();
/*     */   }
/*     */   
/*     */   private static IBlockState getState(BlockPos pos) {
/* 345 */     return mc.field_71441_e.func_180495_p(pos);
/*     */   }
/*     */   
/*     */   public static boolean isBlockAboveEntitySolid(Entity entity) {
/* 349 */     if (entity != null) {
/* 350 */       BlockPos pos = new BlockPos(entity.field_70165_t, entity.field_70163_u + 2.0D, entity.field_70161_v);
/* 351 */       return isBlockSolid(pos);
/*     */     } 
/* 353 */     return false;
/*     */   }
/*     */   
/*     */   public static void debugPos(String message, BlockPos pos) {
/* 357 */     Command.sendMessage(message + pos.func_177958_n() + "x, " + pos.func_177956_o() + "y, " + pos.func_177952_p() + "z");
/*     */   }
/*     */   
/*     */   public static void placeCrystalOnBlock(BlockPos pos, EnumHand hand, boolean swing, boolean exactHand) {
/* 361 */     RayTraceResult result = mc.field_71441_e.func_72933_a(new Vec3d(mc.field_71439_g.field_70165_t, mc.field_71439_g.field_70163_u + mc.field_71439_g.func_70047_e(), mc.field_71439_g.field_70161_v), new Vec3d(pos.func_177958_n() + 0.5D, pos.func_177956_o() - 0.5D, pos.func_177952_p() + 0.5D));
/* 362 */     EnumFacing facing = (result == null || result.field_178784_b == null) ? EnumFacing.UP : result.field_178784_b;
/* 363 */     mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerTryUseItemOnBlock(pos, facing, hand, 0.0F, 0.0F, 0.0F));
/* 364 */     if (swing) {
/* 365 */       mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketAnimation(exactHand ? hand : EnumHand.MAIN_HAND));
/*     */     }
/*     */   }
/*     */   
/*     */   public static BlockPos[] toBlockPos(Vec3d[] vec3ds) {
/* 370 */     BlockPos[] list = new BlockPos[vec3ds.length];
/* 371 */     for (int i = 0; i < vec3ds.length; i++) {
/* 372 */       list[i] = new BlockPos(vec3ds[i]);
/*     */     }
/* 374 */     return list;
/*     */   }
/*     */   
/*     */   public static Vec3d posToVec3d(BlockPos pos) {
/* 378 */     return new Vec3d((Vec3i)pos);
/*     */   }
/*     */   
/*     */   public static BlockPos vec3dToPos(Vec3d vec3d) {
/* 382 */     return new BlockPos(vec3d);
/*     */   }
/*     */   
/*     */   public static Boolean isPosInFov(BlockPos pos) {
/* 386 */     int dirnumber = RotationUtil.getDirection4D();
/* 387 */     if (dirnumber == 0 && pos.func_177952_p() - (mc.field_71439_g.func_174791_d()).field_72449_c < 0.0D) {
/* 388 */       return Boolean.valueOf(false);
/*     */     }
/* 390 */     if (dirnumber == 1 && pos.func_177958_n() - (mc.field_71439_g.func_174791_d()).field_72450_a > 0.0D) {
/* 391 */       return Boolean.valueOf(false);
/*     */     }
/* 393 */     if (dirnumber == 2 && pos.func_177952_p() - (mc.field_71439_g.func_174791_d()).field_72449_c > 0.0D) {
/* 394 */       return Boolean.valueOf(false);
/*     */     }
/* 396 */     return Boolean.valueOf((dirnumber != 3 || pos.func_177958_n() - (mc.field_71439_g.func_174791_d()).field_72450_a >= 0.0D));
/*     */   }
/*     */   
/*     */   public static boolean isBlockBelowEntitySolid(Entity entity) {
/* 400 */     if (entity != null) {
/* 401 */       BlockPos pos = new BlockPos(entity.field_70165_t, entity.field_70163_u - 1.0D, entity.field_70161_v);
/* 402 */       return isBlockSolid(pos);
/*     */     } 
/* 404 */     return false;
/*     */   }
/*     */   
/*     */   public static boolean isBlockSolid(BlockPos pos) {
/* 408 */     return !isBlockUnSolid(pos);
/*     */   }
/*     */   
/*     */   public static boolean isBlockUnSolid(BlockPos pos) {
/* 412 */     return isBlockUnSolid(mc.field_71441_e.func_180495_p(pos).func_177230_c());
/*     */   }
/*     */   
/*     */   public static boolean isBlockUnSolid(Block block) {
/* 416 */     return unSolidBlocks.contains(block);
/*     */   }
/*     */   
/*     */   public static Vec3d[] convertVec3ds(Vec3d vec3d, Vec3d[] input) {
/* 420 */     Vec3d[] output = new Vec3d[input.length];
/* 421 */     for (int i = 0; i < input.length; i++) {
/* 422 */       output[i] = vec3d.func_178787_e(input[i]);
/*     */     }
/* 424 */     return output;
/*     */   }
/*     */   
/*     */   public static Vec3d[] convertVec3ds(EntityPlayer entity, Vec3d[] input) {
/* 428 */     return convertVec3ds(entity.func_174791_d(), input);
/*     */   }
/*     */   
/*     */   public static boolean canBreak(BlockPos pos) {
/* 432 */     IBlockState blockState = mc.field_71441_e.func_180495_p(pos);
/* 433 */     Block block = blockState.func_177230_c();
/* 434 */     return (block.func_176195_g(blockState, (World)mc.field_71441_e, pos) != -1.0F);
/*     */   }
/*     */   
/*     */   public static boolean isValidBlock(BlockPos pos) {
/* 438 */     Block block = mc.field_71441_e.func_180495_p(pos).func_177230_c();
/* 439 */     return (!(block instanceof net.minecraft.block.BlockLiquid) && block.func_149688_o(null) != Material.field_151579_a);
/*     */   }
/*     */   
/*     */   public static boolean isScaffoldPos(BlockPos pos) {
/* 443 */     return (mc.field_71441_e.func_175623_d(pos) || mc.field_71441_e.func_180495_p(pos).func_177230_c() == Blocks.field_150431_aC || mc.field_71441_e.func_180495_p(pos).func_177230_c() == Blocks.field_150329_H || mc.field_71441_e.func_180495_p(pos).func_177230_c() instanceof net.minecraft.block.BlockLiquid);
/*     */   }
/*     */   
/*     */   public static boolean rayTracePlaceCheck(BlockPos pos, boolean shouldCheck, float height) {
/* 447 */     return (!shouldCheck || mc.field_71441_e.func_147447_a(new Vec3d(mc.field_71439_g.field_70165_t, mc.field_71439_g.field_70163_u + mc.field_71439_g.func_70047_e(), mc.field_71439_g.field_70161_v), new Vec3d(pos.func_177958_n(), (pos.func_177956_o() + height), pos.func_177952_p()), false, true, false) == null);
/*     */   }
/*     */   
/*     */   public static boolean rayTracePlaceCheck(BlockPos pos, boolean shouldCheck) {
/* 451 */     return rayTracePlaceCheck(pos, shouldCheck, 1.0F);
/*     */   }
/*     */   
/*     */   public static boolean rayTracePlaceCheck(BlockPos pos) {
/* 455 */     return rayTracePlaceCheck(pos, true);
/*     */   }
/*     */   
/*     */   public static boolean isInHole() {
/* 459 */     BlockPos blockPos = new BlockPos(mc.field_71439_g.field_70165_t, mc.field_71439_g.field_70163_u, mc.field_71439_g.field_70161_v);
/* 460 */     IBlockState blockState = mc.field_71441_e.func_180495_p(blockPos);
/* 461 */     return isBlockValid(blockState, blockPos);
/*     */   }
/*     */   
/*     */   public static double getNearestBlockBelow() {
/* 465 */     for (double y = mc.field_71439_g.field_70163_u; y > 0.0D; ) {
/* 466 */       if (mc.field_71441_e.func_180495_p(new BlockPos(mc.field_71439_g.field_70165_t, y, mc.field_71439_g.field_70161_v)).func_177230_c() instanceof net.minecraft.block.BlockSlab || mc.field_71441_e.func_180495_p(new BlockPos(mc.field_71439_g.field_70165_t, y, mc.field_71439_g.field_70161_v)).func_177230_c().func_176223_P().func_185890_d((IBlockAccess)mc.field_71441_e, new BlockPos(0, 0, 0)) == null) {
/*     */         y -= 0.001D; continue;
/* 468 */       }  return y;
/*     */     } 
/* 470 */     return -1.0D;
...
/* 474 */     if (blockState.func_177230_c() != Blocks.field_150350_a) {
/* 475 */       return false;
/*     */     }
/* 477 */     if (mc.field_71439_g.func_174818_b(blockPos) < 1.0D) {
/* 478 */       return false;
/*     */     }
/* 480 */     if (mc.field_71441_e.func_180495_p(blockPos.func_177984_a()).func_177230_c() != Blocks.field_150350_a) {
/* 481 */       return false;
/*     */     }
/* 483 */     if (mc.field_71441_e.func_180495_p(blockPos.func_177981_b(2)).func_177230_c() != Blocks.field_150350_a) {
/* 484 */       return false;
/*     */     }
/* 486 */     return (isBedrockHole(blockPos) || isObbyHole(blockPos) || isBothHole(blockPos) || isElseHole(blockPos));
...
/* 492 */       if (touchingState.func_177230_c() != Blocks.field_150350_a && touchingState.func_177230_c() == Blocks.field_150343_Z) { b++; continue; }
/* 493 */        return false; }
/*     */     
/* 495 */     return true; }
...
/*     */     int i;
/*     */     byte b;
/* 499 */     for (arrayOfBlockPos = getTouchingBlocks(blockPos), i = arrayOfBlockPos.length, b = 0; b < i; ) { BlockPos pos = arrayOfBlockPos[b];
/* 500 */       IBlockState touchingState = mc.field_71441_e.func_180495_p(pos);
/* 501 */       if (touchingState.func_177230_c() != Blocks.field_150350_a && touchingState.func_177230_c() == Blocks.field_150357_h) { b++; continue; }
/* 502 */        return false; }
/*     */     
/* 504 */     return true; }
...
/*     */     int i;
/*     */     byte b;
/* 508 */     for (arrayOfBlockPos = getTouchingBlocks(blockPos), i = arrayOfBlockPos.length, b = 0; b < i; ) { BlockPos pos = arrayOfBlockPos[b];
/* 509 */       IBlockState touchingState = mc.field_71441_e.func_180495_p(pos);
/* 510 */       if (touchingState.func_177230_c() != Blocks.field_150350_a && (touchingState.func_177230_c() == Blocks.field_150357_h || touchingState.func_177230_c() == Blocks.field_150343_Z)) {
/*     */         b++; continue;
/* 512 */       }  return false; }
/*     */     
/* 514 */     return true; } public static boolean isElseHole(BlockPos blockPos) {
/*     */     BlockPos[] arrayOfBlockPos;
/*     */     int i;
/*     */     byte b;
/* 518 */     for (arrayOfBlockPos = getTouchingBlocks(blockPos), i = arrayOfBlockPos.length, b = 0; b < i; ) { BlockPos pos = arrayOfBlockPos[b];
/* 519 */       IBlockState touchingState = mc.field_71441_e.func_180495_p(pos);
/* 520 */       if (touchingState.func_177230_c() != Blocks.field_150350_a && touchingState.func_185913_b()) { b++; continue; }
/* 521 */        return false; }
/*     */     
/* 523 */     return true;
/*     */   }
...
/* 527 */     return new BlockPos[] { blockPos.func_177978_c(), blockPos.func_177968_d(), blockPos.func_177974_f(), blockPos.func_177976_e(), blockPos.func_177977_b() };
/*     */   }
/*     */ }


/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobo\\util\BlockUtil.class
