...
/* 435 */     int time = func_82145_z();
/* 436 */     if (BetterPortals.getInstance().isOn() && ((Boolean)(BetterPortals.getInstance()).fastPortal.getValue()).booleanValue()) {
/* 437 */       time = ((Integer)(BetterPortals.getInstance()).time.getValue()).intValue();
/*     */     }
/* 439 */     return time;
/*     */   }
/*     */   
...
/* 444 */     PushEvent event = new PushEvent(entity, x, y, z, true);
/* 445 */     MinecraftForge.EVENT_BUS.post((Event)event);
/* 446 */     if (!event.isCanceled()) {
/* 447 */       entity.field_70159_w += event.x;
/* 448 */       entity.field_70181_x += event.y;
/* 449 */       entity.field_70179_y += event.z;
/* 450 */       entity.field_70160_al = event.airbone;
/*     */     } 
/*     */   }
/*     */ }


/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\mixin\mixins\MixinEntity.class
