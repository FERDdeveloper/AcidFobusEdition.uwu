...
/*  14 */   public Setting<String> commandBracket = register(new Setting("Bracket", "§5░"));
/*  15 */   public Setting<String> commandBracket2 = register(new Setting("Bracket2", "§5░"));
/*  16 */   public Setting<String> command = register(new Setting("Command", "§5ａｃｉｄ"));
...
/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\features\modules\client\Managers.class
