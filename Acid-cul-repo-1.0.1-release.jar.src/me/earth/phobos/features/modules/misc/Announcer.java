...
/*  13 */   private final Setting<Boolean> join = register(new Setting("Join", Boolean.valueOf(true))); private static final String directory = "phobos/announcer/";
...
/*  56 */       String fileName = "phobos/announcer/" + action.getName() + ".txt";
...
/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\features\modules\misc\Announcer.class
