...
/* 20 */       sendMessage("You`ll find the config files in your gameProfile directory under phobos/config");
/*    */       return;
/*    */     } 
/* 23 */     if (commands.length == 2) {
/* 24 */       if ("list".equals(commands[0])) {
/* 25 */         String configs = "Configs: ";
/* 26 */         File file = new File("acid/");
...
/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\features\command\commands\ConfigCommand.class
