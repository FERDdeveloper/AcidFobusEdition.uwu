...
/* 17 */   public Setting<Integer> fontStyle = register(new Setting("FontStyle", Integer.valueOf(2), "Style of the font."));
...
/* 20 */   public Setting<Boolean> shadow = register(new Setting("Shadow", Boolean.valueOf(false), "Less shadow offset font."));
/* 21 */   public Setting<Boolean> showFonts = register(new Setting("Fonts", Boolean.valueOf(false), "Shows all fonts."));
/* 22 */   public Setting<Boolean> full = register(new Setting("Full", Boolean.valueOf(true)));
/*    */   private boolean reloadFont = false;
/*    */   
/*    */   public FontMod() {
/* 26 */     super("CustomFont", "CustomFont for all of the clients text. Use the font command.", Module.Category.CLIENT, true, false, true);
/* 27 */     setInstance();
/*    */   }
/*    */   
...
/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\features\modules\client\FontMod.class
