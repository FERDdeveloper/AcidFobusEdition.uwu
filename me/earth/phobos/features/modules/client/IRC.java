...
/*     */   
/*     */   public IRC() {
/*  70 */     super("PhobosChat", "Phobos chat server", Module.Category.CLIENT, true, false, true);
/*  71 */     INSTANCE = this;
/*     */   }
/*     */   
...
/* 280 */       Command.sendMessage("§aIRC connected successfully!");
/*     */     } else {
/* 282 */       Command.sendMessage("§cIRC is already connected!");
/*     */     } 
/*     */   }
/*     */   
...
/*     */       }
/*     */     } else {
/* 293 */       Command.sendMessage("§cIRC is not connected!");
/*     */     } 
/*     */   }
/*     */   
...
/*     */     
/*     */     public void run() {
/* 358 */       Command.sendMessage("§aSocket thread starting!");
/*     */ 
/*     */ 
/*     */       
/*     */       while (true) {
...
/* 368 */             Command.sendMessage("§c[IRC] §r<" + name + ">: " + message);
/*     */           } 
...
/* 375 */               Command.sendMessage("§b" + friend.replace("_&_", " ID: "));
/*     */             }
...
/* 384 */                 Command.sendMessage("§b" + friend + " has been friended");
/*     */               } 
/*     */             } 
...
/* 395 */             Command.sendMessage("§c[IRC] §r" + name + " has set a waypoint at §c(" + Integer.parseInt(inputs[2]) + "," + Integer.parseInt(inputs[3]) + "," + Integer.parseInt(inputs[4]) + ")§r on the server §c" + server + "§r in the dimension §c" + IRC.getDimension(Integer.parseInt(dimension)));
...
/* 402 */             Command.sendMessage("§c[IRC] §r" + name + " has removed their waypoint");
...
/* 418 */             Command.sendMessage("§c[IRC]§r Active Users:");
...
/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\features\modules\client\IRC.class
