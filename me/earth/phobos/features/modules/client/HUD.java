...
/*  41 */   private final Setting<String> customWatermark = register(new Setting("WatermarkName", "megyn.club b1"));
...
/*  60 */   private final Setting<Greeter> greeter = register(new Setting("Welcomer", Greeter.NONE, "Greets you."));
/*  61 */   private final Setting<String> spoofGreeter = register(new Setting("GreeterName", "3arthqu4ke", v -> (this.greeter.getValue() == Greeter.CUSTOM)));
...
/*     */       
/*     */       case CUSTOM:
/* 215 */         this.renderer.drawString((String)this.customWatermark.getValue() + (((Boolean)this.modeVer.getValue()).booleanValue() ? " v1.0.1" : ""), 2.0F, 2.0F, (((Boolean)this.rolling.getValue()).booleanValue() && ((Boolean)this.rainbow.getValue()).booleanValue()) ? ((Integer)this.colorMap.get(Integer.valueOf(2))).intValue() : this.color, true);
/*     */         break;
/*     */     } 
/*     */     
...
/* 227 */           String text = module.getDisplayName() + "§7" + ((module.getDisplayInfo() != null) ? (" [§f" + module.getDisplayInfo() + "§7]") : "");
...
/* 235 */           String text = module.getDisplayName() + "§7" + ((module.getDisplayInfo() != null) ? (" [§f" + module.getDisplayInfo() + "§7]") : "");
...
/* 249 */         String text2 = grayString + "Server brand §f" + Phobos.serverManager.getServerBrand();
...
/* 269 */         String text2 = grayString + "Speed §f" + Phobos.speedManager.getSpeedKpH() + " km/h";
...
/* 278 */         String text2 = grayString + "Time §f" + (new SimpleDateFormat("h:mm a")).format(new Date());
...
/* 288 */         if (itemDamage > 0) {
/* 289 */           String str1 = grayString + "Durability §a" + itemDamage;
...
/* 299 */         String text2 = grayString + "TPS §f" + Phobos.serverManager.getTPS();
...
/*     */       } 
/* 307 */       String fpsText = grayString + "FPS §f" + Minecraft.field_71470_ab;
/* 308 */       String text = grayString + "Ping §f" + (ServerModule.getInstance().isConnected() ? ServerModule.getInstance().getServerPing() : Phobos.serverManager.getPing()) + (((Boolean)this.MS.getValue()).booleanValue() ? "ms" : "");
...
/* 346 */         String text2 = grayString + "Server brand §f" + Phobos.serverManager.getServerBrand();
...
/* 356 */         String text2 = grayString + "Speed §f" + Phobos.speedManager.getSpeedKpH() + " km/h";
...
/* 360 */         String text2 = grayString + "Time §f" + (new SimpleDateFormat("h:mm a")).format(new Date());
...
/* 365 */         if (itemDamage > 0) {
/* 366 */           String str = grayString + "Durability §a" + itemDamage;
...
/* 371 */         String text2 = grayString + "TPS §f" + Phobos.serverManager.getTPS();
...
/*     */       } 
/* 374 */       String fpsText = grayString + "FPS §f" + Minecraft.field_71470_ab;
/* 375 */       String text = grayString + "Ping §f" + Phobos.serverManager.getPing();
...
/* 405 */     String coordinates = grayString + "XYZ §f" + posX + ", " + posY + ", " + posZ + " §r" + grayString + "[§f" + hposX + ", " + hposZ + "§r" + grayString + "]";
...
/*     */       
/*     */       case ACID:
/* 454 */         text = text + "Welcome to Acid " + mc.field_71439_g.getDisplayNameString();
/*     */         break;
/*     */       
/*     */       case CUSTOM:
/* 458 */         text = text + (String)this.spoofGreeter.getValue();
/*     */         break;
/*     */       
/*     */       default:
/* 462 */         text = text + "Welcome " + mc.field_71439_g.getDisplayNameString();
/*     */         break;
/*     */     } 
/*     */     
/* 466 */     this.renderer.drawString(text, width / 2.0F - this.renderer.getStringWidth(text) / 2.0F + 2.0F, 2.0F, (((Boolean)this.rolling.getValue()).booleanValue() && ((Boolean)this.rainbow.getValue()).booleanValue()) ? ((Integer)this.colorMap.get(Integer.valueOf(2))).intValue() : this.color, true);
/*     */   }
/*     */   
/*     */   public void renderLag() {
/* 470 */     int width = this.renderer.scaledWidth;
/* 471 */     if (Phobos.serverManager.isServerNotResponding()) {
/* 472 */       String text = ((this.lag.getValue() == LagNotify.GRAY) ? "§7" : "§c") + "Server not responding: " + MathUtil.round((float)Phobos.serverManager.serverRespondingTime() / 1000.0F, 1) + "s.";
/* 473 */       this.renderer.drawString(text, width / 2.0F - this.renderer.getStringWidth(text) / 2.0F + 2.0F, 20.0F, (((Boolean)this.rolling.getValue()).booleanValue() && ((Boolean)this.rainbow.getValue()).booleanValue()) ? ((Integer)this.colorMap.get(Integer.valueOf(20))).intValue() : this.color, true);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 481 */     int width = this.renderer.scaledWidth;
/* 482 */     int height = this.renderer.scaledHeight;
/* 483 */     int totems = mc.field_71439_g.field_71071_by.field_70462_a.stream().filter(itemStack -> (itemStack.func_77973_b() == Items.field_190929_cY)).mapToInt(ItemStack::func_190916_E).sum();
/* 484 */     if (mc.field_71439_g.func_184592_cb().func_77973_b() == Items.field_190929_cY) {
/* 485 */       totems += mc.field_71439_g.func_184592_cb().func_190916_E();
/*     */     }
/* 487 */     if (totems > 0) {
/* 488 */       GlStateManager.func_179098_w();
/* 489 */       int i = width / 2;
/* 490 */       int iteration = 0;
/* 491 */       int y = height - 55 - ((mc.field_71439_g.func_70090_H() && mc.field_71442_b.func_78763_f()) ? 10 : 0);
/* 492 */       int x = i - 189 + 180 + 2;
/* 493 */       GlStateManager.func_179126_j();
/* 494 */       RenderUtil.itemRender.field_77023_b = 200.0F;
/* 495 */       RenderUtil.itemRender.func_180450_b(totem, x, y);
/* 496 */       RenderUtil.itemRender.func_180453_a(mc.field_71466_p, totem, x, y, "");
/* 497 */       RenderUtil.itemRender.field_77023_b = 0.0F;
/* 498 */       GlStateManager.func_179098_w();
/* 499 */       GlStateManager.func_179140_f();
/* 500 */       GlStateManager.func_179097_i();
/* 501 */       this.renderer.drawStringWithShadow(totems + "", (x + 19 - 2 - this.renderer.getStringWidth(totems + "")), (y + 9), 16777215);
/* 502 */       GlStateManager.func_179126_j();
/* 503 */       GlStateManager.func_179140_f();
/*     */     } 
/*     */   }
/*     */   
/*     */   public void renderArmorHUD(boolean percent) {
/* 508 */     int width = this.renderer.scaledWidth;
/* 509 */     int height = this.renderer.scaledHeight;
/* 510 */     GlStateManager.func_179098_w();
/* 511 */     int i = width / 2;
/* 512 */     int iteration = 0;
/* 513 */     int y = height - 55 - ((mc.field_71439_g.func_70090_H() && mc.field_71442_b.func_78763_f()) ? 10 : 0);
/* 514 */     for (ItemStack is : mc.field_71439_g.field_71071_by.field_70460_b) {
/* 515 */       iteration++;
/* 516 */       if (is.func_190926_b()) {
/*     */         continue;
/*     */       }
/* 519 */       int x = i - 90 + (9 - iteration) * 20 + 2;
/* 520 */       GlStateManager.func_179126_j();
/* 521 */       RenderUtil.itemRender.field_77023_b = 200.0F;
/* 522 */       RenderUtil.itemRender.func_180450_b(is, x, y);
/* 523 */       RenderUtil.itemRender.func_180453_a(mc.field_71466_p, is, x, y, "");
/* 524 */       RenderUtil.itemRender.field_77023_b = 0.0F;
/* 525 */       GlStateManager.func_179098_w();
/* 526 */       GlStateManager.func_179140_f();
/* 527 */       GlStateManager.func_179097_i();
/* 528 */       String s = (is.func_190916_E() > 1) ? (is.func_190916_E() + "") : "";
/* 529 */       this.renderer.drawStringWithShadow(s, (x + 19 - 2 - this.renderer.getStringWidth(s)), (y + 9), 16777215);
/* 530 */       if (!percent) {
/*     */         continue;
/*     */       }
/* 533 */       int dmg = 0;
/* 534 */       int itemDurability = is.func_77958_k() - is.func_77952_i();
/* 535 */       float green = (is.func_77958_k() - is.func_77952_i()) / is.func_77958_k();
/* 536 */       float red = 1.0F - green;
/* 537 */       if (percent) {
/* 538 */         dmg = 100 - (int)(red * 100.0F);
/*     */       } else {
/* 540 */         dmg = itemDurability;
/*     */       } 
/* 542 */       this.renderer.drawStringWithShadow(dmg + "", (x + 8 - this.renderer.getStringWidth(dmg + "") / 2), (y - 11), ColorUtil.toRGBA((int)(red * 255.0F), (int)(green * 255.0F), 0));
/*     */     } 
/* 544 */     GlStateManager.func_179126_j();
/* 545 */     GlStateManager.func_179140_f();
/*     */   }
/*     */   
/*     */   public void drawHitMarkers() {
/* 549 */     ScaledResolution resolution = new ScaledResolution(mc);
/* 550 */     RenderUtil.drawLine(resolution.func_78326_a() / 2.0F - 4.0F, resolution.func_78328_b() / 2.0F - 4.0F, resolution.func_78326_a() / 2.0F - 8.0F, resolution.func_78328_b() / 2.0F - 8.0F, 1.0F, ColorUtil.toRGBA(255, 255, 255, 255));
/* 551 */     RenderUtil.drawLine(resolution.func_78326_a() / 2.0F + 4.0F, resolution.func_78328_b() / 2.0F - 4.0F, resolution.func_78326_a() / 2.0F + 8.0F, resolution.func_78328_b() / 2.0F - 8.0F, 1.0F, ColorUtil.toRGBA(255, 255, 255, 255));
/* 552 */     RenderUtil.drawLine(resolution.func_78326_a() / 2.0F - 4.0F, resolution.func_78328_b() / 2.0F + 4.0F, resolution.func_78326_a() / 2.0F - 8.0F, resolution.func_78328_b() / 2.0F + 8.0F, 1.0F, ColorUtil.toRGBA(255, 255, 255, 255));
/* 553 */     RenderUtil.drawLine(resolution.func_78326_a() / 2.0F + 4.0F, resolution.func_78328_b() / 2.0F + 4.0F, resolution.func_78326_a() / 2.0F + 8.0F, resolution.func_78328_b() / 2.0F + 8.0F, 1.0F, ColorUtil.toRGBA(255, 255, 255, 255));
/*     */   }
/*     */   
/*     */   public void drawTextRadar(int yOffset) {
/* 557 */     if (!this.players.isEmpty()) {
/* 558 */       int y = this.renderer.getFontHeight() + 7 + yOffset;
/* 559 */       for (Map.Entry<String, Integer> player : this.players.entrySet()) {
/* 560 */         String text = (String)player.getKey() + " ";
/* 561 */         int textheight = this.renderer.getFontHeight() + 1;
/* 562 */         this.renderer.drawString(text, 2.0F, y, (((Boolean)this.rolling.getValue()).booleanValue() && ((Boolean)this.rainbow.getValue()).booleanValue()) ? ((Integer)this.colorMap.get(Integer.valueOf(y))).intValue() : this.color, true);
/* 563 */         y += textheight;
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\42060\Downloads\Acid_4\Acid-cul-repo-1.0.1-release.jar!\me\earth\phobos\features\modules\client\HUD.class
